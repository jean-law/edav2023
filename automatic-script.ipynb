   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "['Outside of R', 'Data Collection and Preprocessing', 'Programming Techniques and Tools', 'Parameter Analysis of Visualization Techniques', 'Interactive and Web-based Applications', 'Data Visualization Techniques', 'Statistical Analysis and Modelling']\n"
     ]
    }
   ],
   "source": [
